...
export default function ConsultationTable() {
  ...
  const loadBookings = () => {
    const allBookings = getBookingsByType('consultation')
    setBookings(allBookings)
    setStats(getBookingStats('consultation'))
  }

  const handleStatusUpdate = (id, status) => {
    updateBookingStatus('consultation', id, status)
    loadBookings()
  }

  const filteredBookings = filterBookingsByStatus('consultation', filter)
              ...
              <tbody className="divide-y divide-gray-200">
                {filteredBookings.map((booking, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-gray-700">Dr. {booking.doctor}</td>
                    ...
                    <td className="px-6 py-4 text-gray-700 text-sm">{booking.issue?.substring(0, 30)}...</td>
                    <td className="px-6 py-4">
